...
Let’s use a real-world repository to introduce KnitPkg’s core ideas: the [**SMA project**](https://forge.mql5.io/DouglasRechia/sma/src/commit/d50674497d1664b21acb0caf056c6e2f8d7be413). You're encouraged to browse and explore the SMA repo, even if *another* SMA implementation doesn't seem
to be interesting to you. :smile:
